...
<div class="login-container">
	...
	<div class="login-form">
		...
		<div class="login-content">
			...
			<a href="#" class="logo">
				<img src="<?= base_url()?>/assets/images/vci.png" width="120" alt="" />
			</a>
			
			<form method="post" role="form" id="form_forgot_password" action="<?= base_url().'/Login/forget_password'?>">
					...
					<div class="step current" id="step-1">
						...
						<div class="form-group">
							...
							<div class="input-group">
								...
								<input type="text" class="form-control" name="employee_nik" id="employee_nik" placeholder="NIK" autocomplete="off" />
							</div>
