...
<div class="row">
	<div class="col-md-12">
		...
		<form method="post" id="input_form" action="/index.php/Master/Master_gallery/save_gc" class="form-horizontal form-groups-bordered" enctype="multipart/form-data">
			<div class="row">
			...
			<div class="panel panel-primary" data-collapsed="0">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<textarea id="gallery_link" name="gallery_link" required="true" class="form-control" placeholder="Link Instagram"></textarea>
