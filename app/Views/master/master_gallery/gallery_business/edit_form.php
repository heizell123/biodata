...
<div class="row">
	<div class="col-md-12">
		...
		<form method="post" id="input_form" action="/index.php/Master/Master_gallery/update_gb" class="form-horizontal form-groups-bordered" enctype="multipart/form-data">
			<div class="row">
			...
			<div class="panel panel-primary" data-collapsed="0">
				...
				<div class="panel-body">
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="hidden" name="gb_id" value="<?= $gallery[0]['gb_id']?>">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							...
							<a target="_blank" href="<?= base_url().'/public/resto_assets'?>/assets/img/gallery_business/<?=$gallery[0]['gallery_img']?>"><?=$gallery[0]['gallery_img']?></a>
