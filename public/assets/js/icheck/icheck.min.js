...
(function(f) {
    ...
    function x(a, b, d) {
        ...
        if (!0 !== c[b]) { if (!d && b == k && c[_type] == r && c.name) { var w = a.closest("form"),
                ...
                p.each(function() { this !== c && f(this).data(m) && q(f(this), b) }) } u ? (c[b] = !0, c[k] && q(a, k, "force")) : (d || (c[b] = !0), e && c[_indeterminate] && q(a, _indeterminate, !1));
            D(a, e, b, d) } c[n] && l(a, _cursor, !0) && g.find("." + C).css(_cursor, "default");
        g[_add](B || l(a, b) || "");
